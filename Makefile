...
PKG_RELEASE:=testing
PKG_VERSION:=2.0
PKG_SOURCE_URL:=https://github.com/WindSpiritSR/sie8021xclient/archive/refs/tags
PKG_SOURCE:=ver_$(PKG_VERSION).tar.gz
PKG_MD5SUM:=85f5f00afe51323d4b5dace066b251a0
